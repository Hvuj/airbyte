...
class CustomQuery(IncrementalGoogleAdsStream):
    ...
    def get_query(self, stream_slice: Mapping[str, Any] = None) -> str:
        return self.insert_segments_date_expr(self.user_defined_query)
    ...
    @staticmethod
    def insert_segments_date_expr(query: str) -> str:
        """
